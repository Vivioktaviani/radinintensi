...
<html>
<head>
<title> Kepala Koordinator | Laporan Bulanan Di simpan Anda</title>
<meta charset="utf-8">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <ul class="sidebar-menu">					
			<li class="header"><h4><b><center>Laporan Tersimpan</center></b></h4></li>
            <li class="active"><a href="home.php"><i class="fa fa-home"></i><span>Dokumen Masuk</span></a></li>
...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Data Laporan Bulanan Yang Tersimpan
          </h1>

...
if(!in_array($ext,$ekstensi) ) {
	...
	if($ukuran < 8000000){		
		...
		$sql = "INSERT INTO dokumen (nomor_dokumen, nama_dokumen, tanggal_dokumen, tujuan_dokumen, file_dokumen) VALUES ('$nomor_dokumen', '$nama_dokumen', '$tanggal_dokumen', '$tujuan_dokumen', '$path');";

		mysqli_query($connect, $sql);
		
		header("location:home.php?alert=berhasil");

		$sql2 = "INSERT INTO riwayat_pengiriman(tanggal, tujuan, status, komentar, nip, nomor_dokumen, keterangan) VALUES ('$tanggal_dokumen','$tujuan_dokumen','0','-','$nip','$nomor_dokumen','Tambah');";
